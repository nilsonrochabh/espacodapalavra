...
class ClienteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.ClienteTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Cliente';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Cliente';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nome', 'Endereco', 'Telefone', 'Email', 'DataCadastro', ),
        self::TYPE_CAMELNAME     => array('id', 'nome', 'endereco', 'telefone', 'email', 'dataCadastro', ),
        self::TYPE_COLNAME       => array(ClienteTableMap::COL_ID, ClienteTableMap::COL_NOME, ClienteTableMap::COL_ENDERECO, ClienteTableMap::COL_TELEFONE, ClienteTableMap::COL_EMAIL, ClienteTableMap::COL_DATA_CADASTRO, ),
        self::TYPE_FIELDNAME     => array('id', 'nome', 'endereco', 'telefone', 'email', 'data_cadastro', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nome' => 1, 'Endereco' => 2, 'Telefone' => 3, 'Email' => 4, 'DataCadastro' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nome' => 1, 'endereco' => 2, 'telefone' => 3, 'email' => 4, 'dataCadastro' => 5, ),
        self::TYPE_COLNAME       => array(ClienteTableMap::COL_ID => 0, ClienteTableMap::COL_NOME => 1, ClienteTableMap::COL_ENDERECO => 2, ClienteTableMap::COL_TELEFONE => 3, ClienteTableMap::COL_EMAIL => 4, ClienteTableMap::COL_DATA_CADASTRO => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nome' => 1, 'endereco' => 2, 'telefone' => 3, 'email' => 4, 'data_cadastro' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Cliente');
        $this->setPackage('Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, 10, null);
        $this->addColumn('nome', 'Nome', 'VARCHAR', true, 45, null);
        $this->addColumn('endereco', 'Endereco', 'VARCHAR', false, 45, null);
    ...
    {
        $this->addRelation('Pedido', '\\Model\\Pedido', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_cliente',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Cliente) { // it's a model object
