...
class UsuarioTableMap extends TableMap
{
     ...
     */
    const COL_HABILITADO = 'usuario.habilitado';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nome', 'Email', 'Senha', 'DataCadastro', 'Habilitado', ),
        self::TYPE_CAMELNAME     => array('id', 'nome', 'email', 'senha', 'dataCadastro', 'habilitado', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID, UsuarioTableMap::COL_NOME, UsuarioTableMap::COL_EMAIL, UsuarioTableMap::COL_SENHA, UsuarioTableMap::COL_DATA_CADASTRO, UsuarioTableMap::COL_HABILITADO, ),
        self::TYPE_FIELDNAME     => array('id', 'nome', 'email', 'senha', 'data_cadastro', 'habilitado', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nome' => 1, 'Email' => 2, 'Senha' => 3, 'DataCadastro' => 4, 'Habilitado' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nome' => 1, 'email' => 2, 'senha' => 3, 'dataCadastro' => 4, 'habilitado' => 5, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID => 0, UsuarioTableMap::COL_NOME => 1, UsuarioTableMap::COL_EMAIL => 2, UsuarioTableMap::COL_SENHA => 3, UsuarioTableMap::COL_DATA_CADASTRO => 4, UsuarioTableMap::COL_HABILITADO => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nome' => 1, 'email' => 2, 'senha' => 3, 'data_cadastro' => 4, 'habilitado' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('senha', 'Senha', 'VARCHAR', true, 250, null);
        $this->addColumn('data_cadastro', 'DataCadastro', 'TIMESTAMP', true, null, null);
        $this->addColumn('habilitado', 'Habilitado', 'BOOLEAN', true, 1, false);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_HABILITADO);
        } else {
