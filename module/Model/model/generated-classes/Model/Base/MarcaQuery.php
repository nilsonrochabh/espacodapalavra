 ...
 * 
 *
 * @method     ChildMarcaQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildMarcaQuery orderByNome($order = Criteria::ASC) Order by the nome column
 *
 * @method     ChildMarcaQuery groupById() Group by the id column
 * @method     ChildMarcaQuery groupByNome() Group by the nome column
 *
 ...
 *
 * @method     ChildMarcaQuery leftJoinProdutoBase($relationAlias = null) Adds a LEFT JOIN clause to the query using the ProdutoBase relation
 * @method     ChildMarcaQuery rightJoinProdutoBase($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ProdutoBase relation
 * @method     ChildMarcaQuery innerJoinProdutoBase($relationAlias = null) Adds a INNER JOIN clause to the query using the ProdutoBase relation
 *
 * @method     ChildMarcaQuery joinWithProdutoBase($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ProdutoBase relation
 *
 * @method     ChildMarcaQuery leftJoinWithProdutoBase() Adds a LEFT JOIN clause and with to the query using the ProdutoBase relation
 * @method     ChildMarcaQuery rightJoinWithProdutoBase() Adds a RIGHT JOIN clause and with to the query using the ProdutoBase relation
 * @method     ChildMarcaQuery innerJoinWithProdutoBase() Adds a INNER JOIN clause and with to the query using the ProdutoBase relation
 *
 * @method     \Model\ProdutoBaseQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildMarca findOneById(int $id) Return the first ChildMarca filtered by the id column
 * @method     ChildMarca findOneByNome(string $nome) Return the first ChildMarca filtered by the nome column *
 ...
 *
 * @method     ChildMarca requireOneById(int $id) Return the first ChildMarca filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildMarca requireOneByNome(string $nome) Return the first ChildMarca filtered by the nome column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildMarca[]|ObjectCollection findById(int $id) Return ChildMarca objects filtered by the id column
 * @method     ChildMarca[]|ObjectCollection findByNome(string $nome) Return ChildMarca objects filtered by the nome column
...
abstract class MarcaQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Base\MarcaQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Marca', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = MarcaTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, nome FROM marca WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = new ChildMarca();
            $obj->hydrate($row);
            MarcaTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(MarcaTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(MarcaTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(MarcaTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(MarcaTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MarcaTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByNome($nome = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(MarcaTableMap::COL_NOME, $nome, $comparison);
    }
    ...
    public function filterByProdutoBase($produtoBase, $comparison = null)
    {
        if ($produtoBase instanceof \Model\ProdutoBase) {
            return $this
                ->addUsingAlias(MarcaTableMap::COL_ID, $produtoBase->getIdMarca(), $comparison);
    ...
    {
        if ($marca) {
            $this->addUsingAlias(MarcaTableMap::COL_ID, $marca->getId(), Criteria::NOT_EQUAL);
        }
