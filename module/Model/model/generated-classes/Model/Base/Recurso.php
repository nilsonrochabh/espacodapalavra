 ...
 */
abstract class Recurso implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\RecursoTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Recurso object.
     */
    ...
    /**
     * Compares this with another <code>Recurso</code> instance.  If
     * <code>obj</code> is an instance of <code>Recurso</code>, delegates to
     * <code>equals(Recurso)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Recurso The current object, for fluid interface
     */
     ...
     * @return $this|\Model\Recurso The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RecursoTableMap::COL_ID] = true;
        }
    ...
    public function setDescricao($v)
    {
        ...
        if ($this->descricao !== $v) {
            $this->descricao = $v;
            $this->modifiedColumns[RecursoTableMap::COL_DESCRICAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RecursoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RecursoTableMap::translateFieldName('Descricao', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = RecursoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Recurso'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRecursoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Recurso::setDeleted()
     * @see Recurso::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRecursoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RecursoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[RecursoTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . RecursoTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(RecursoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(RecursoTableMap::COL_DESCRICAO)) {
    ...
    {
        $pos = RecursoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Recurso'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Recurso'][$this->hashCode()] = true;
        $keys = RecursoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Recurso The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(RecursoTableMap::DATABASE_NAME);

        if ($this->isColumnModified(RecursoTableMap::COL_ID)) {
            $criteria->add(RecursoTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(RecursoTableMap::COL_DESCRICAO)) {
            $criteria->add(RecursoTableMap::COL_DESCRICAO, $this->descricao);
        }
    ...
    {
        $criteria = ChildRecursoQuery::create();
        $criteria->add(RecursoTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Recurso (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Recurso Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildRecurso is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildRecurso The current object (for fluent API support)
     */
    public function setRecursoProposicaos(Collection $recursoProposicaos, ConnectionInterface $con = null)
    {
        ...
        foreach ($recursoProposicaosToDelete as $recursoProposicaoRemoved) {
            $recursoProposicaoRemoved->setRecurso(null);
        }
    ...
    protected function doAddRecursoProposicao(ChildRecursoProposicao $recursoProposicao)
    {
        ...
        $recursoProposicao->setRecurso($this);
    }
    ...
    public function removeRecursoProposicao(ChildRecursoProposicao $recursoProposicao)
    {
        if ($this->getRecursoProposicaos()->contains($recursoProposicao)) {
            ...
            $recursoProposicao->setRecurso(null);
        }
     ...
     * @return ObjectCollection|ChildRecursoProposicao[] List of ChildRecursoProposicao objects
     */
    public function getRecursoProposicaosJoinProposicao(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildRecursoProposicaoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(RecursoTableMap::DEFAULT_STRING_FORMAT);
    }
