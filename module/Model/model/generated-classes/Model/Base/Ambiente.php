 ...
 */
abstract class Ambiente implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\AmbienteTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Ambiente object.
     */
    ...
    /**
     * Compares this with another <code>Ambiente</code> instance.  If
     * <code>obj</code> is an instance of <code>Ambiente</code>, delegates to
     * <code>equals(Ambiente)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Ambiente The current object, for fluid interface
     */
     ...
     * @return $this|\Model\Ambiente The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AmbienteTableMap::COL_ID] = true;
        }
    ...
    public function setDescricao($v)
    {
        ...
        if ($this->descricao !== $v) {
            $this->descricao = $v;
            $this->modifiedColumns[AmbienteTableMap::COL_DESCRICAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AmbienteTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AmbienteTableMap::translateFieldName('Descricao', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = AmbienteTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Ambiente'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAmbienteQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Ambiente::setDeleted()
     * @see Ambiente::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAmbienteQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AmbienteTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AmbienteTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AmbienteTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AmbienteTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AmbienteTableMap::COL_DESCRICAO)) {
            $modifiedColumns[':p' . $index++]  = 'descricao';
        }

        $sql = sprintf(
            'INSERT INTO ambiente (%s) VALUES (%s)',
    ...
    {
        $pos = AmbienteTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Ambiente'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Ambiente'][$this->hashCode()] = true;
        $keys = AmbienteTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Ambiente The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(AmbienteTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AmbienteTableMap::COL_ID)) {
            $criteria->add(AmbienteTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AmbienteTableMap::COL_DESCRICAO)) {
            $criteria->add(AmbienteTableMap::COL_DESCRICAO, $this->descricao);
        }
    ...
    {
        $criteria = ChildAmbienteQuery::create();
        $criteria->add(AmbienteTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Ambiente (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Ambiente Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildAmbiente is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAmbiente The current object (for fluent API support)
     */
    public function setAmbienteProposicaos(Collection $ambienteProposicaos, ConnectionInterface $con = null)
    {
        ...
        foreach ($ambienteProposicaosToDelete as $ambienteProposicaoRemoved) {
            $ambienteProposicaoRemoved->setAmbiente(null);
        }
    ...
    protected function doAddAmbienteProposicao(ChildAmbienteProposicao $ambienteProposicao)
    {
        ...
        $ambienteProposicao->setAmbiente($this);
    }
    ...
    public function removeAmbienteProposicao(ChildAmbienteProposicao $ambienteProposicao)
    {
        if ($this->getAmbienteProposicaos()->contains($ambienteProposicao)) {
            ...
            $ambienteProposicao->setAmbiente(null);
        }
     ...
     * @return ObjectCollection|ChildAmbienteProposicao[] List of ChildAmbienteProposicao objects
     */
    public function getAmbienteProposicaosJoinProposicao(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAmbienteProposicaoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(AmbienteTableMap::DEFAULT_STRING_FORMAT);
    }
