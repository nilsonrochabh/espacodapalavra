...
abstract class Usuario implements ActiveRecordInterface 
{
    ...
    /**
     * Sets the value of the [habilitado] column.
    ...
    public function setHabilitado($v)
    {
        ...
        if ($this->habilitado !== $v) {
            $this->habilitado = $v;
            $this->modifiedColumns[UsuarioTableMap::COL_HABILITADO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsuarioTableMap::translateFieldName('DataCadastro', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->data_cadastro = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsuarioTableMap::translateFieldName('Habilitado', TableMap::TYPE_PHPNAME, $indexType)];
            $this->habilitado = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsuarioTableMap::COL_HABILITADO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'data_cadastro':                        
                        ...
                        break;
                    case 'habilitado':
                        $stmt->bindValue($identifier, (int) $this->habilitado, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioTableMap::COL_HABILITADO)) {
            $criteria->add(UsuarioTableMap::COL_HABILITADO, $this->habilitado);
        }
