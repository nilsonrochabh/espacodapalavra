...
abstract class Marca implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\MarcaTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Marca object.
     */
     ...
     * @return $this|\Model\Marca The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MarcaTableMap::COL_ID] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[MarcaTableMap::COL_NOME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MarcaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MarcaTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = MarcaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Marca'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MarcaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(MarcaTableMap::COL_NOME)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Marca The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MarcaTableMap::COL_ID)) {
            $criteria->add(MarcaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MarcaTableMap::COL_NOME)) {
            $criteria->add(MarcaTableMap::COL_NOME, $this->nome);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Marca (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Marca Clone of current object.
     * @throws PropelException
     */
    ...
    public function setProdutoBases(Collection $produtoBases, ConnectionInterface $con = null)
    {
        ...
        foreach ($produtoBasesToDelete as $produtoBaseRemoved) {
            $produtoBaseRemoved->setMarca(null);
        }
