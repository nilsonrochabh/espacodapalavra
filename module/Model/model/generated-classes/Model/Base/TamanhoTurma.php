...
/**
 * Base class that represents a row from the 'tamanho_turma' table.
 *
 *
 *
 * @package    propel.generator.Model.Base
 */
abstract class TamanhoTurma implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\TamanhoTurmaTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\TamanhoTurma object.
     */
    ...
    /**
     * Compares this with another <code>TamanhoTurma</code> instance.  If
     * <code>obj</code> is an instance of <code>TamanhoTurma</code>, delegates to
     * <code>equals(TamanhoTurma)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TamanhoTurma The current object, for fluid interface
     */
     ...
     * @return $this|\Model\TamanhoTurma The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TamanhoTurmaTableMap::COL_ID] = true;
        }
    ...
    public function setDescricao($v)
    {
        ...
        if ($this->descricao !== $v) {
            $this->descricao = $v;
            $this->modifiedColumns[TamanhoTurmaTableMap::COL_DESCRICAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TamanhoTurmaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TamanhoTurmaTableMap::translateFieldName('Descricao', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = TamanhoTurmaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\TamanhoTurma'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTamanhoTurmaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TamanhoTurma::setDeleted()
     * @see TamanhoTurma::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTamanhoTurmaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TamanhoTurmaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TamanhoTurmaTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TamanhoTurmaTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TamanhoTurmaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TamanhoTurmaTableMap::COL_DESCRICAO)) {
            $modifiedColumns[':p' . $index++]  = 'descricao';
        }

        $sql = sprintf(
            'INSERT INTO tamanho_turma (%s) VALUES (%s)',
    ...
    {
        $pos = TamanhoTurmaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TamanhoTurma'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TamanhoTurma'][$this->hashCode()] = true;
        $keys = TamanhoTurmaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\TamanhoTurma
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\TamanhoTurma The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(TamanhoTurmaTableMap::DATABASE_NAME);

        if ($this->isColumnModified(TamanhoTurmaTableMap::COL_ID)) {
            $criteria->add(TamanhoTurmaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TamanhoTurmaTableMap::COL_DESCRICAO)) {
            $criteria->add(TamanhoTurmaTableMap::COL_DESCRICAO, $this->descricao);
        }
    ...
    {
        $criteria = ChildTamanhoTurmaQuery::create();
        $criteria->add(TamanhoTurmaTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\TamanhoTurma (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\TamanhoTurma Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTamanhoTurma is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTamanhoTurma The current object (for fluent API support)
     */
    public function setTamanhoTurmaProposicaos(Collection $tamanhoTurmaProposicaos, ConnectionInterface $con = null)
    {
        ...
        foreach ($tamanhoTurmaProposicaosToDelete as $tamanhoTurmaProposicaoRemoved) {
            $tamanhoTurmaProposicaoRemoved->setTamanhoTurma(null);
        }
    ...
    protected function doAddTamanhoTurmaProposicao(ChildTamanhoTurmaProposicao $tamanhoTurmaProposicao)
    {
        ...
        $tamanhoTurmaProposicao->setTamanhoTurma($this);
    }
    ...
    public function removeTamanhoTurmaProposicao(ChildTamanhoTurmaProposicao $tamanhoTurmaProposicao)
    {
        if ($this->getTamanhoTurmaProposicaos()->contains($tamanhoTurmaProposicao)) {
            ...
            $tamanhoTurmaProposicao->setTamanhoTurma(null);
        }
     ...
     * Otherwise if this TamanhoTurma is new, it will return
     * an empty collection; or if this TamanhoTurma has previously
     * been saved, it will retrieve related TamanhoTurmaProposicaos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TamanhoTurma.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTamanhoTurmaProposicao[] List of ChildTamanhoTurmaProposicao objects
     */
    public function getTamanhoTurmaProposicaosJoinProposicao(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTamanhoTurmaProposicaoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TamanhoTurmaTableMap::DEFAULT_STRING_FORMAT);
    }
