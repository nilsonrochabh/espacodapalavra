...
/**
 * Base class that represents a row from the 'tipo_producao' table.
 *
 * 
 *
* @package    propel.generator.Model.Base
*/
abstract class TipoProducao implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\TipoProducaoTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\TipoProducao object.
     */
    ...
    /**
     * Compares this with another <code>TipoProducao</code> instance.  If
     * <code>obj</code> is an instance of <code>TipoProducao</code>, delegates to
     * <code>equals(TipoProducao)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TipoProducao The current object, for fluid interface
     */
     ...
     * @return $this|\Model\TipoProducao The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TipoProducaoTableMap::COL_ID] = true;
        }
    ...
    public function setIdReceita($v)
    {
        ...
        if ($this->id_receita !== $v) {
            $this->id_receita = $v;
            $this->modifiedColumns[TipoProducaoTableMap::COL_ID_RECEITA] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[TipoProducaoTableMap::COL_NOME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TipoProducaoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TipoProducaoTableMap::translateFieldName('IdReceita', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_receita = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TipoProducaoTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = TipoProducaoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\TipoProducao'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTipoProducaoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TipoProducao::setDeleted()
     * @see TipoProducao::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTipoProducaoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TipoProducaoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TipoProducaoTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TipoProducaoTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TipoProducaoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TipoProducaoTableMap::COL_ID_RECEITA)) {
            $modifiedColumns[':p' . $index++]  = 'id_receita';
        }
        if ($this->isColumnModified(TipoProducaoTableMap::COL_NOME)) {
            $modifiedColumns[':p' . $index++]  = 'nome';
        }

        $sql = sprintf(
            'INSERT INTO tipo_producao (%s) VALUES (%s)',
    ...
    {
        $pos = TipoProducaoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TipoProducao'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TipoProducao'][$this->hashCode()] = true;
        $keys = TipoProducaoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\TipoProducao
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\TipoProducao The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(TipoProducaoTableMap::DATABASE_NAME);

        if ($this->isColumnModified(TipoProducaoTableMap::COL_ID)) {
            $criteria->add(TipoProducaoTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TipoProducaoTableMap::COL_ID_RECEITA)) {
            $criteria->add(TipoProducaoTableMap::COL_ID_RECEITA, $this->id_receita);
        }
        if ($this->isColumnModified(TipoProducaoTableMap::COL_NOME)) {
            $criteria->add(TipoProducaoTableMap::COL_NOME, $this->nome);
        }
    ...
    {
        $criteria = ChildTipoProducaoQuery::create();
        $criteria->add(TipoProducaoTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\TipoProducao (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\TipoProducao Clone of current object.
     * @throws PropelException
     */
    ...
    public function getReceita(ConnectionInterface $con = null)
    {
        if ($this->aReceita === null && ($this->id_receita !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aReceita->addTipoProducaos($this);
             */
        }
     ...
     * If this ChildTipoProducao is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTipoProducao The current object (for fluent API support)
     */
    public function setProducaos(Collection $producaos, ConnectionInterface $con = null)
    {
        ...
        foreach ($producaosToDelete as $producaoRemoved) {
            $producaoRemoved->setTipoProducao(null);
        }
     ...
     * Otherwise if this TipoProducao is new, it will return
     * an empty collection; or if this TipoProducao has previously
     * been saved, it will retrieve related Producaos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TipoProducao.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildProducao[] List of ChildProducao objects
     */
    public function getProducaosJoinPedido(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProducaoQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aReceita) {
            $this->aReceita->removeTipoProducao($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(TipoProducaoTableMap::DEFAULT_STRING_FORMAT);
    }
