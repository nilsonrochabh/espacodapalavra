...
/**
 * Base class that represents a row from the 'habilidade' table.
 *
 *
 *
 * @package    propel.generator.Model.Base
 */
abstract class Habilidade implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\HabilidadeTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Habilidade object.
     */
    ...
    /**
     * Compares this with another <code>Habilidade</code> instance.  If
     * <code>obj</code> is an instance of <code>Habilidade</code>, delegates to
     * <code>equals(Habilidade)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Habilidade The current object, for fluid interface
     */
     ...
     * @return $this|\Model\Habilidade The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[HabilidadeTableMap::COL_ID] = true;
        }
    ...
    public function setDescricao($v)
    {
        ...
        if ($this->descricao !== $v) {
            $this->descricao = $v;
            $this->modifiedColumns[HabilidadeTableMap::COL_DESCRICAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : HabilidadeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HabilidadeTableMap::translateFieldName('Descricao', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = HabilidadeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Habilidade'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHabilidadeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Habilidade::setDeleted()
     * @see Habilidade::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHabilidadeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HabilidadeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[HabilidadeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . HabilidadeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(HabilidadeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(HabilidadeTableMap::COL_DESCRICAO)) {
            $modifiedColumns[':p' . $index++]  = 'descricao';
        }

        $sql = sprintf(
            'INSERT INTO habilidade (%s) VALUES (%s)',
    ...
    {
        $pos = HabilidadeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Habilidade'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Habilidade'][$this->hashCode()] = true;
        $keys = HabilidadeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Habilidade The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(HabilidadeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(HabilidadeTableMap::COL_ID)) {
            $criteria->add(HabilidadeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(HabilidadeTableMap::COL_DESCRICAO)) {
            $criteria->add(HabilidadeTableMap::COL_DESCRICAO, $this->descricao);
        }
    ...
    {
        $criteria = ChildHabilidadeQuery::create();
        $criteria->add(HabilidadeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Habilidade (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Habilidade Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildHabilidade is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildHabilidade The current object (for fluent API support)
     */
    public function setHabilidadeProposicaos(Collection $habilidadeProposicaos, ConnectionInterface $con = null)
    {
        ...
        foreach ($habilidadeProposicaosToDelete as $habilidadeProposicaoRemoved) {
            $habilidadeProposicaoRemoved->setHabilidade(null);
        }
    ...
    protected function doAddHabilidadeProposicao(ChildHabilidadeProposicao $habilidadeProposicao)
    {
        ...
        $habilidadeProposicao->setHabilidade($this);
    }
    ...
    public function removeHabilidadeProposicao(ChildHabilidadeProposicao $habilidadeProposicao)
    {
        if ($this->getHabilidadeProposicaos()->contains($habilidadeProposicao)) {
            ...
            $habilidadeProposicao->setHabilidade(null);
        }
     ...
     * Otherwise if this Habilidade is new, it will return
     * an empty collection; or if this Habilidade has previously
     * been saved, it will retrieve related HabilidadeProposicaos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Habilidade.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildHabilidadeProposicao[] List of ChildHabilidadeProposicao objects
     */
    public function getHabilidadeProposicaosJoinProposicao(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildHabilidadeProposicaoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(HabilidadeTableMap::DEFAULT_STRING_FORMAT);
    }
