...
*/
abstract class Local implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\LocalTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Local object.
     */
    ...
    /**
     * Compares this with another <code>Local</code> instance.  If
     * <code>obj</code> is an instance of <code>Local</code>, delegates to
     * <code>equals(Local)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Local The current object, for fluid interface
     */
     ...
     * @return $this|\Model\Local The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LocalTableMap::COL_ID] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[LocalTableMap::COL_NOME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LocalTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LocalTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = LocalTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Local'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLocalQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLocalQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LocalTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[LocalTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . LocalTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(LocalTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(LocalTableMap::COL_NOME)) {
    ...
    {
        $pos = LocalTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Local'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Local'][$this->hashCode()] = true;
        $keys = LocalTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNome(),
        );
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Local The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(LocalTableMap::DATABASE_NAME);

        if ($this->isColumnModified(LocalTableMap::COL_ID)) {
            $criteria->add(LocalTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LocalTableMap::COL_NOME)) {
            $criteria->add(LocalTableMap::COL_NOME, $this->nome);
        }
    ...
    {
        $criteria = ChildLocalQuery::create();
        $criteria->add(LocalTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Local (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Local Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildLocal is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildLocal The current object (for fluent API support)
     */
     ...
     * @return ObjectCollection|ChildProduto[] List of ChildProduto objects
     */
    public function getProdutosJoinProdutoBase(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProdutoQuery::create(null, $criteria);
        $query->joinWith('ProdutoBase', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(LocalTableMap::DEFAULT_STRING_FORMAT);
    }
